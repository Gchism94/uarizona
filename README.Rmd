...
<!-- badges: start -->
[![R-CMD-check](https://github.com/aidangildea/uarizona/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/aidangildea/uarizona/actions/workflows/R-CMD-check.yaml){.pkgdown-devel}
